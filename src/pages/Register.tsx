    ...
    <div className="w-full h-full min-h-screen py-30 flex flex-col items-center justify-start bg-linear-to-t from-sky-500 to-indigo-500 p-6.25">
      <form className="w-full h-auto p-4 max-w-150 bg-white rounded-xl shadow-lg border border-gray-200 gap-4 flex flex-col items-start justify-start" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="w-full h-auto flex flex-col items-start justify-start gap-2">
          <label htmlFor="username" className="text-left text-[14px] font-semibold">Username <span className="text-red-500">*</span></label>
        ...
        <div className="w-full h-auto flex flex-col items-start justify-start gap-2">
          <label htmlFor="fullname" className="text-left text-[14px] font-semibold">Fullname <span className="text-red-500">*</span></label>
          <div className="w-full h-auto flex flex-col items-start justify-start gap-0.5">
            <input
              id="fullname"
              className="w-full h-auto px-4 py-2 rounded-lg cursor-text border-2 border-gray-300 text-left text-[12px] outline-none"
            ...
            />
            {errors.fullname && <p className="text-left text-[12px] text-red-500">{errors.fullname.message}</p>}
          </div>
        </div>

        <div className="w-full h-auto flex flex-col items-start justify-start gap-2">
          <label htmlFor="password" className="text-left text-[14px] font-semibold">Password <span className="text-red-500">*</span></label>
          <div className="w-full h-auto flex flex-col items-start justify-start gap-0.5">
        ...
        <div className="w-full h-auto flex flex-col items-start justify-start gap-1.5">
          <button
            className={`w-full h-auto text-white font-bold py-2 px-4 rounded-lg text-center text-[14px] ${isSubmitting || !captchaToken ? 'bg-gray-500 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-600 cursor-pointer'}`}
            type="submit"
          ...
          <div className='w-full h-auto flex items-center justify-between'>
            <Link to="/login" className="text-blue-500 hover:underline text-[14px]">Do you have an account? Login</Link>
          </div>
        </div>
      </form>
    </div>
