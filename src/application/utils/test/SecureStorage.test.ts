...
describe('SecureStorage interface', () => {
  it('should throw error when invoke abstract behavior', async () => {
    ...
    mockMethodAssertion.assertImplemented(secureStorage, 'setSecureItem', 'SECURE_STORAGE.METHOD_NOT_IMPLEMENTED')
    mockMethodAssertion.assertImplemented(secureStorage, 'getSecureItem', 'SECURE_STORAGE.METHOD_NOT_IMPLEMENTED')
    mockMethodAssertion.assertImplemented(secureStorage, 'removeSecureItem', 'SECURE_STORAGE.METHOD_NOT_IMPLEMENTED')
